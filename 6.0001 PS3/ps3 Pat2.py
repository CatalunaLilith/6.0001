...
def is_valid_word(word, hand, word_list):
    ...
    #test if valid move   
    #if * in test_word, then substitute * with each char of VOWELS, then test if in word_list
        #if mod_test_word in word_list:
            #bool = True
        #else: #done
            #bool = False #done
...
#for test 
#is_valid_word('Rapture', {'r': 1, 'a': 3, 'p': 2, 'e': 1, 't': 1, 'u': 1}, ['rapture', 'cats', 'kittens'])
